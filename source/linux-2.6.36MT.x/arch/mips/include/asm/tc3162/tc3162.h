/*
** $Id: tc3162.h,v 1.3.2.1 2012-03-06 13:01:46 kurtis Exp $
*/
/************************************************************************
 *
...
/*
** $Log: tc3162.h,v $
** Revision 1.3.2.1  2012-03-06 13:01:46  kurtis
** remove rt63365 keyword to rt6855A
**
** Revision 1.3  2011-09-14 03:16:45  bruce
** sync from bbu
**
** Revision 1.2  2011-05-05 14:26:58  bruce
** patch for FPGA CHIP ID change to 4
**
** Revision 1.1  2011-04-11 06:41:56  bruce
** add BBU BSP header file
**
...
#define isRT6855A 	(((VPint(0xbfb00064)&0xffff0000))==0x00040000)
...
#define	RT6855A_SYS_HCLK       	(VPint(0xbfb0008c)&(1<<31) ? (25) : (VPint(0xbfb0008c)&(1<<9) ? (VPint(0xbfb0008c)&(1<<25) ? (VPint(0xbfb0008c)&(1<<26) ? (175) : (23333/100)) : (140)) : (VPint(0xbfb0008c)&(1<<25) ? (VPint(0xbfb0008c)&(1<<26) ? (125) : (16667/100)) : (140))))

#define   SYS_HCLK                (isRT6855A ? RT6855A_SYS_HCLK : (isRT63165 ? RT63165_SYS_HCLK : (isTC3182 ? (1024/10) : (3*((VPint(0xbfb00058)>>16)+1)/(((VPint(0xbfb00058)&0x1f)+1)<<1)))))
#endif
...
#define	CR_UART_RBR     	(0x00+CR_UART_BASE+0x00)
#define	CR_UART_THR     	(0x00+CR_UART_BASE+0x00)
#define	CR_UART_IER     	(0x04+CR_UART_BASE+0x00)
#define	CR_UART_IIR     	(0x08+CR_UART_BASE+0x00)
#define	CR_UART_FCR     	(0x08+CR_UART_BASE+0x00)
#define	CR_UART_LCR     	(0x0c+CR_UART_BASE+0x00)
#define	CR_UART_MCR     	(0x10+CR_UART_BASE+0x00)
#define	CR_UART_LSR     	(0x14+CR_UART_BASE+0x00)
#define	CR_UART_MSR     	(0x18+CR_UART_BASE+0x00)
#define	CR_UART_SCR     	(0x1c+CR_UART_BASE+0x00)
#define	CR_UART_BRDL    	(0x00+CR_UART_BASE+0x00)
#define	CR_UART_BRDH    	(0x04+CR_UART_BASE+0x00)
#define	CR_UART_WORDA		(0x20+CR_UART_BASE+0x00)
#define	CR_UART_HWORDA		(0x28+CR_UART_BASE+0x00)
#define	CR_UART_MISCC		(0x24+CR_UART_BASE+0x00)
...
#define	CR_HSUART_RBR     	(0x00+CR_HSUART_BASE+0x00)
#define	CR_HSUART_THR     	(0x00+CR_HSUART_BASE+0x00)
#define	CR_HSUART_IER     	(0x04+CR_HSUART_BASE+0x00)
#define	CR_HSUART_IIR     	(0x08+CR_HSUART_BASE+0x00)
#define	CR_HSUART_FCR     	(0x08+CR_HSUART_BASE+0x00)
#define	CR_HSUART_LCR     	(0x0c+CR_HSUART_BASE+0x00)
#define	CR_HSUART_MCR     	(0x10+CR_HSUART_BASE+0x00)
#define	CR_HSUART_LSR     	(0x14+CR_HSUART_BASE+0x00)
#define	CR_HSUART_MSR     	(0x18+CR_HSUART_BASE+0x00)
#define	CR_HSUART_SCR     	(0x1c+CR_HSUART_BASE+0x00)
#define	CR_HSUART_BRDL    	(0x00+CR_HSUART_BASE+0x00)
#define	CR_HSUART_BRDH    	(0x04+CR_HSUART_BASE+0x00)
#define	CR_HSUART_WORDA		(0x20+CR_HSUART_BASE+0x00)
#define	CR_HSUART_HWORDA	(0x28+CR_HSUART_BASE+0x00)
#define	CR_HSUART_MISCC		(0x24+CR_HSUART_BASE+0x00)
