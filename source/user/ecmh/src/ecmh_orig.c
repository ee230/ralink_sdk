...
***************************************
 $Author: yy $
 $Id: ecmh_orig.c,v 1.1.4.1 2012-02-07 12:49:43 yy Exp $
 $Date: 2012-02-07 12:49:43 $
***************************************
...
#endif /* IGNORE_INTERFACE1 */

#ifdef IGNORE_INTERFACE2
			if( !strcmp(IGNORE_INTERFACE2, 
#ifndef ECMH_GETIFADDR
                                        devname
#else
                                        ifa->ifa_name
...
int main(int argc, char *argv[])
{
	...
	/* Handle arguments */
	while ((i = getopt_long(argc, argv, "dfi:pPu:"
#ifdef ECMH_BPF
		"tT"
#endif
		"vV"
