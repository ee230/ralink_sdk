...
var wdsEncrypType  = '<% getCfg2General(1, "WdsEncrypType"); %>';
var wdsEncrypKey0  = '<% getCfg2General(1, "Wds0Key"); %>';
var wdsEncrypKey1  = '<% getCfg2General(1, "Wds1Key"); %>';
var wdsEncrypKey2  = '<% getCfg2General(1, "Wds2Key"); %>';
var wdsEncrypKey3  = '<% getCfg2General(1, "Wds3Key"); %>';
...
<form method=post name=wireless_wds action="/goform/inicWds" onSubmit="return CheckValue()">
