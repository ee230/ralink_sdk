...
/* UP_MAP_VPRI=0x8C */
#define DFL_UP0_VPRI		(0x1) /* user pri 0 map to vlan pri tag */
#define DFL_UP1_VPRI		(0x2) /* user pri 1 map to vlan pri tag */
#define DFL_UP2_VPRI		(0x3) /* user pri 2 map to vlan pri tag */
#define DFL_UP3_VPRI		(0x4) /* user pri 3 map to vlan pri tag */
#define DFL_UP4_VPRI		(0x5) /* user pri 4 map to vlan pri tag */
#define DFL_UP5_VPRI		(0x6) /* user pri 5 map to vlan pri tag */
#define DFL_UP6_VPRI		(0x7) /* user pri 6 map to vlan pri tag */
#define DFL_UP7_VPRI		(0x8) /* user pri 7 map to vlan pri tag */
