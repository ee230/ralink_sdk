...
/* $Id: mtd.h,v 1.2 2009-03-17 09:20:51 winfred Exp $ */
...
extern struct mtd_info *__get_mtd_device_nm(struct mtd_info *mtd, char *name);

static inline struct mtd_info *get_mtd_device_nm(struct mtd_info *mtd, char *name)
{
	struct mtd_info *ret;
	
	ret = __get_mtd_device_nm(mtd, name);
