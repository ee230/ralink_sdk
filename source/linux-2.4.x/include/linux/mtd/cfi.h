 ...
 * $Id: cfi.h,v 1.3 2007-11-05 12:29:58 steven Exp $
 */
...
struct cfi_intelext_blockinfo {
  __u16 NumIdentBlocks;
  __u16 BlockSize;
  __u16 MinBlockEraseCycles;
  __u8  BitsPerCell;
  __u8  BlockCap;
}__attribute__((packed));

struct cfi_intelext_regioninfo {
  __u16 NumIdentPartitions;
  __u8  NumOpAllowed;
  __u8  NumOpAllowedSimProgMode;
  __u8  NumOpAllowedSimEraMode;
  __u8  NumBlockTypes;
