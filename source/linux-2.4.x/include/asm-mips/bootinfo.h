...
#define MACH_GROUP_RT2880      23 /* Ralink RA2880 SOC 			    */
...
/*
 *  * Valid machtype for group MACH_GROUP_RA2880
 *   */
#define MACH_RALINK_UNUSED     0
#define MACH_RALINK_AP2880     1       /* 2880 SOC */
