...
#define RT2880_SERIAL_PORT_DEFNS					\
	{ baud_base: SURFBOARD_BASE_BAUD,				\
	  port: SURFBOARD_UART_REGS_BASE,				\
	  irq: SURFBOARDINT_UART, flags: STD_COM_FLAGS },  /* ttyS0 */	\
	{ baud_base: SURFBOARD_BASE_BAUD,				\
	  port: SURFBOARD_UART1_REGS_BASE,				\
	  irq: SURFBOARDINT_UART1, flags: STD_COM_FLAGS }, /* ttyS1 */
#else
#define RT2880_SERIAL_PORT_DEFNS
#endif
