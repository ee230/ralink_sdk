...
/* ++ bobtseng update */
unsigned long mips_machgroup = MACH_GROUP_RT2880; /* update the mach group from running source, no comment in original code */
/* -- bobtseng update, 2006.1.3. */
