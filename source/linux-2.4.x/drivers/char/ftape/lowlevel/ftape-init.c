...
/*      Global vars.
 */
char ft_src[] __initdata = "$Source: /home/cvsroot/RT288x_SDK/source/linux-2.4.x/drivers/char/ftape/lowlevel/ftape-init.c,v $";
char ft_rev[] __initdata = "$Revision: 1.1.1.1 $";
char ft_dat[] __initdata = "$Date: 2006-10-13 02:42:48 $";
