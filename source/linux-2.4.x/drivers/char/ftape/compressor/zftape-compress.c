 ...
 */
 ...
 char zftc_src[] ="$Source: /home/cvsroot/RT288x_SDK/source/linux-2.4.x/drivers/char/ftape/compressor/zftape-compress.c,v $";
 char zftc_rev[] = "$Revision: 1.1.1.1 $";
 char zftc_dat[] = "$Date: 2006-10-13 02:42:48 $";
