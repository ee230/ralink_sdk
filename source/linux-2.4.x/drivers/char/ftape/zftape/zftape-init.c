...
char zft_src[] __initdata = "$Source: /home/cvsroot/RT288x_SDK/source/linux-2.4.x/drivers/char/ftape/zftape/zftape-init.c,v $";
char zft_rev[] __initdata = "$Revision: 1.1.1.1 $";
char zft_dat[] __initdata = "$Date: 2006-10-13 02:42:48 $";
